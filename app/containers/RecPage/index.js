...
DeviceRecPage.propTypes = {
  ...
  function mapDispatchToProps(dispatch) {
    return dispatch(serviceCall(UserInfoSecJson));
  //  return dispatch(serviceCall(state,'SERVICE_CALL'));
  //  {
  ...
  const mapStateToProps = state => {
    return {
      upgradeUser:makeSelectDevicePageUser(),
